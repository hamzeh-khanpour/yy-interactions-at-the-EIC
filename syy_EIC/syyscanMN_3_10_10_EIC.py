...
for wv in wlist:
    ...
    if inelastic:
        flux_inel_w = Syy.flux_inel_yy_atW(wv, 18.0, 275.0, q2emax, mNmax, q2pmax)
        # print(flux_inel_w)
    ...
    flux_el = Syy.flux_el_yy_atW(wv, 18.0, 275.0, q2emax, q2pmax)
    # print(flux_el)
...
with open('3_10_10_EIC.dat', 'w') as f:

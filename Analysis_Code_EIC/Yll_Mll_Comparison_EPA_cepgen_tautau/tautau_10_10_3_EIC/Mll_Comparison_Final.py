...
def compare_Mll_distributions(filename_root):
    ...
    tree_E = file_root.Get("EIC_E")
    tree_QE = file_root.Get("EIC_QE")
    ...
    hist_Mll_E = ROOT.TH1F("hist_Mll_E", "Mll distribution", 100, 5, 100)
    hist_Mll_QE = ROOT.TH1F("hist_Mll_QE", "Mll distribution", 100, 5, 100)
...
##################################################################
    ...
    bin_edges = np.linspace(5, 100, 101)
...
compare_Mll_distributions("EIC_Compare_E_QE.root")

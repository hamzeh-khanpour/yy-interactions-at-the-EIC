...
#  Hamzeh Khanpour -- 30 Sepyember May 2024
...
integrated_cross_section_value_E  = 32.93  # pb
integrated_cross_section_value_QE = 11.69  # pb
...
def compare_distributions(filename):
    ...
    tree_E = file.Get("EIC_E")
    tree_QE = file.Get("EIC_QE")
    ...
    hist_Mll_E = ROOT.TH1F("hist_Mll_E", "Mll distribution", 100, 0, 100)
    hist_Mll_QE = ROOT.TH1F("hist_Mll_QE", "Mll distribution", 100, 0, 100)
    hist_Yll_E = ROOT.TH1F("hist_Yll_E", "Yll distribution", 20, -10.0, 10.0)
    hist_Yll_QE = ROOT.TH1F("hist_Yll_QE", "Yll distribution", 20, -10.0, 10.0)
    hist_q2prime_E = ROOT.TH1F("hist_q2prime_E", "q2 proton distribution", 10, 0.0, 10.0)
    hist_q2prime_QE = ROOT.TH1F("hist_q2prime_QE", "q2 proton distribution", 10, 0.0, 10.0)
    hist_q2_E = ROOT.TH1F("hist_q2_E", "q2 electron distribution", 10, 0.0, 10.0)
    hist_q2_QE = ROOT.TH1F("hist_q2_QE", "q2 electron distribution", 10, 0.0, 10.0)
    hist_Ptll_E = ROOT.TH1F("hist_Ptll_E", "Ptll distribution", 10, 0.0, 10.0)
    hist_Ptll_QE = ROOT.TH1F("hist_Ptll_QE", "Ptll distribution", 10, 0.0, 10.0)
...
##################################################################
    ...
    latex_Mll.DrawLatex(0.15, 0.8,
                        "Q^{2}_{e,max}<10 GeV^{2},  Q^{2}_{p,max}<10 GeV^{2}, M_{N} < 10 GeV")
...
#    canvas_q2prime.SetLogx()    
    ...
    canvas_q2prime.SaveAs("q2proton.pdf")
...
#    canvas_q2.SetLogx()
    ...
    canvas_q2.SaveAs("q2_electron.pdf")
...
compare_distributions("EIC_Compare_E_QE.root")

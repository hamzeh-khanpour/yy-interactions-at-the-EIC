...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/Desktop/EIC/EIC_100K_E.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hamzeh-khanpour/Desktop/EIC/EIC_100K_E.root");
      }
